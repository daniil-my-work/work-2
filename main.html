            ...
            <nav class="header__nav">
                <ul class="header__nav-list">
                    <li class="header__nav-item">
                        <a class="header__nav-item-link" href="#">
                            Главная
                        </a>
                    </li>
        ...
        <div class="page__main">
            ...
            <div class="menu">
                <div class="menu__wrapper">
                    ...
                    <ul class="menu__list">
                        <li class="menu__item">
                            <img src="https://102922.selcdn.ru/nomenclature_images_test/1926609/7a849eb1-7100-4d77-bde2-d6bac3002d46.jpg"
                    ...
                    <nav class="menu__nav">
                        <button class="menu__nav-button menu__nav-button--prev">
                            <svg class="menu__nav-button-img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                                <path stroke="currentColor" stroke-width="2px" stroke-linecap="square"
                                    d="m26.1 46-2-2 11.8-11.7-11.8-11.7 2-2 13.8 13.7L26.1 46" />
                            </svg>
                        </button>
